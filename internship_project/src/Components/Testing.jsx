...
const Testing = () => {
    ...
    const [conversations, setConversations] = useState([
        ...
        },
        {
            ...
            messages: [
                { id: 1, role: "bot", text: "Energy policy involves..." },
                { id: 2, role: "user", text: "What is energy policy?" },
            ],
        },
    ]);
        ...
        <div className="content-container">
            <div className="content-header">
                ...
                <div className="header-button">
                    ...
                    <button className="clear-btn" onClick={openClearHistoryWindow} disabled={status === "loading"}>
                        Clear History
                    </button>
                </div>
            </div>
